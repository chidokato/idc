        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Mã NV</label>
              <input type="text" name="employee_code" class="form-control" value="{{ old('employee_code', $userData->employee_code) }}">
            </div>
            <div class="form-group">
              <label>Họ và tên</label>
              <input type="text" name="yourname" class="form-control" value="{{ old('yourname', $userData->yourname) }}">
            </div>
            <div class="form-group">
              <label>Email</label>
              <input type="text" name="email" class="form-control" value="{{ old('email', $userData->email) }}">
            </div>
            <div class="form-group">
              <label>Email phụ</label>
              <input type="text" name="secondary_email" class="form-control" value="{{ old('secondary_email', $userData->secondary_email) }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label>Địa chỉ</label>
              <input type="text" name="address" class="form-control" value="{{ old('address', $userData->address) }}">
            </div>
            <div class="form-group">
              <label>Facebook</label>
              <input type="text" name="facebook" class="form-control" value="{{ old('facebook', $userData->facebook) }}">
            </div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="password" name="password" class="form-control" placeholder="{{ $formMethod === 'POST' ? 'Nhập mật khẩu' : 'Để trống nếu không đổi' }}">
            </div>
            <div class="form-group">
